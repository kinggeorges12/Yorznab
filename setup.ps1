...
Write-Host -NoNewline "API Key (current: $($r_ApiKey.Length) chars): "
...
Write-Host -NoNewline "API Key (current: $($s_ApiKey.Length) chars): "
...
Write-Host -NoNewline "API Key (current: $($QApiKey.Length) chars): "
