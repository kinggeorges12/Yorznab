...
echo -n "ApiKey (current: ${#r_ApiKey} chars): "
...
echo -n "ApiKey (current: ${#s_ApiKey} chars): "
...
echo -n "ApiKey (current: ${#QApiKey} chars): "
...
check_for_dash "ApiKey" "$new_r_ApiKey" "$r_ApiKey"
check_for_dash "Endpoint" "$new_r_Endpoint" "$r_Endpoint"
echo "Sonarr:" >> "$output_file"
check_for_dash "Url" "$new_s_Url" "$s_Url"
check_for_dash "ApiKey" "$new_s_ApiKey" "$s_ApiKey"
check_for_dash "Endpoint" "$new_s_Endpoint" "$s_Endpoint"
echo "qBittorrent:" >> "$output_file"
check_for_dash "QUrl" "$new_QUrl" "$QUrl"
check_for_dash "QApiKey" "$new_QApiKey" "$QApiKey"
check_for_dash "QUsername" "$new_QUsername" "$QUsername"
check_for_dash "QPassword" "$new_QPassword" "$QPassword"
check_for_dash "QEndpoint" "$new_QEndpoint" "$QEndpoint"
echo
